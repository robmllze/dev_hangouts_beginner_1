...
final _lora = GoogleFonts.lora(color: Colors.blue[900]);
final _poppins800 = GoogleFonts.poppins(color: Colors.blue[800]);
final _poppins700 = GoogleFonts.poppins(color: const Color.fromRGBO(25, 118, 210, 1));
